...
<!-- //****************************************************************************************************************************************/-->
            <?php
              //Este array es de freddy rojas para combiar de ingles a español 
        ...
        <div class="extras">
            ...
            <input type="button" id="calcular" class="button" value="Calcular">
                  ...
                  <div class="total">
                      ...
                      <input id="btnRegistro" class="button" type="submit" name="submit" value="Pagar">
                  </div><!--.total-->
              </div><!--.caja-->
          </div><!--#resumen-->
        </form>
