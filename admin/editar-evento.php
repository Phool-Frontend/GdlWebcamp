                          ...
                          <div class="card-body">
                                ...
                                <div class="form-group">
                                  ...
                                  ?>
                                    <div class="input-group">
                                      ...
                                      <input  id="fecha"  type="text" class="form-control" name="fecha_evento" value=" <?php echo $fecha_formato; ?>">
                                    </div>
                                    <!-- /.input group -->
                                </div>
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="input-group date" id="timepicker" data-target-input="nearest">
                                    <input type="text" name="hora_evento" class="form-control datetimepicker-input" data-target="#timepicker" data-toggle="datetimepicker" value=" <?php echo $hora_formato; ?>">
